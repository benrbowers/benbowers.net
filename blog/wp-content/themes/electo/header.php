...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
  	...
  	<?php 
	if ( function_exists( 'electo_contact_info' ) ) {
		electo_contact_info(); 
	}?>
	...
	<div class="electo-banner-area">
		...
		<?php if( is_front_page() ) :
				...
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					electo_banner_slider();
				else :
					electo_banner_background();
				endif;
			else : ?>
			<div class="header-background other-header">
				...
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() : electo_get_breadcrumb() );
						}else{
							electo_get_breadcrumb();
						}?></div>
					<?php endif; ?>
				</div>
			</div>
