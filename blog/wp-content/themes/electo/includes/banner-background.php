...
function electo_banner_background() {
	
	$title = get_theme_mod('banner_sub_title', __('Looking for an Electrician', 'electo'));
	//$fornt_img = get_theme_mod('banner_side_img',get_stylesheet_directory_uri() . '/images/banner-img-01.png');
	$subtitle = get_theme_mod('banner_main_title', __('Welcome to Electo', 'electo'));
	$subpera = get_theme_mod('banner_para', __('Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusm tempor', 'electo'));
	$button_text1 = get_theme_mod('banner_btn1_txt', __('Ready to start', 'electo'));
	$button_text2 = get_theme_mod('banner_btn2_txt', __('Know more', 'electo'));
